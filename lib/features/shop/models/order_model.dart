...
class OrderModel {
  ...
  /// Added by MrBahun final string docId;
  final String id;
  final String userId;
  ...
  OrderModel({
    ...
    /// Added by MrBahun required this.docId;
    required this.id,
    this.userId = '',
  ...
  String get formattedOrderDate =>
      BaakasHelperFunctions.getFormattedDate(orderDate);

  String get formattedDeliveryDate =>
      deliveryDate != null
          ? BaakasHelperFunctions.getFormattedDate(deliveryDate!)
          : '';
