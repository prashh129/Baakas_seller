...
class CartController extends GetxController {
  ...
  void addToCart(ProductModel product) {
    ...
    if (productQuantityInCart.value < 1) {
      BaakasLoaders.customToast(message: 'Select Quantity');
      return;
    }
    ...
    if (product.productType == ProductType.variable.toString() &&
      ...
      BaakasLoaders.customToast(message: 'Select Variation');
      return;
    }
  ...
  void removeFromCartDialog(int index) {
    Get.defaultDialog(
      ...
      onConfirm: () {
        ...
        cartItems.removeAt(index);
        updateCart();
        BaakasLoaders.customToast(message: 'Product removed from the Cart.');
        Get.back();
      },
      onCancel: () => () => Get.back(),
    );
  ...
  void loadCartItems() async {
    final cartItemStrings = BaakasLocalStorage.instance()
  ...
  void saveCartItems() {
    ...
    BaakasLocalStorage.instance().writeData('cartItems', cartItemStrings);
  }
