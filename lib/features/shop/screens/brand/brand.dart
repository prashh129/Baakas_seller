import 'package:baakas_seller/common/widgets/shimmers/vertical_product_shimmer.dart';
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              /// Banner
              BaakasBrandCard(brand: brand, showBorder: true),
              ...
              FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  const loader = BaakasVerticalProductShimmer();
                  final widget =
                  ...
                  return BaakasSortableProducts(products: brandProducts);
                },
              ),
            ],
          ),
