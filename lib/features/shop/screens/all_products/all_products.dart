...
class AllProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: BaakasAppBar(title: Text(title), showBackArrow: true),
        ...
        child: Padding(
          ...
          child: FutureBuilder(
            ...
            builder: (_, snapshot) {
              ...
              final widget = BaakasCloudHelperFunctions.checkMultiRecordState(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        SizedBox(
            height: BaakasDeviceUtils.getBottomNavigationBarHeight() +
