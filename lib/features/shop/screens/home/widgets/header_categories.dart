...
class BaakasHeaderCategories extends StatelessWidget {
  /// Constructor for [BaakasHeaderCategories].
  const BaakasHeaderCategories({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.only(left: BaakasSizes.defaultSpace),
      child: Column(
                ...
                return SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, index) {
                      ...
                      return BaakasVerticalImageAndText(
                        title: category.name,
