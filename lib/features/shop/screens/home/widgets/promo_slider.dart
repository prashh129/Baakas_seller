...
class BaakasPromoSlider extends StatelessWidget {
  const BaakasPromoSlider({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      if (controller.bannersLoading.value) {
        return const BaakasShimmerEffect(width: double.infinity, height: 190);
      }
