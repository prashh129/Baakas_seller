  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        child: Obx(
          () => FutureBuilder(
            ...
            builder: (_, snapshot) {
              ...
              final response = BaakasCloudHelperFunctions.checkMultiRecordState(
                snapshot: snapshot,
              );
                    ...
                    (_, index) => BaakasSingleAddress(
                      ...
                      onTap: () async {
                        Get.defaultDialog(
                          ...
                          content: const BaakasCircularLoader(),
                        );
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: const Icon(Iconsax.add, color: BaakasColors.white),
      ),
    );
  }
}
