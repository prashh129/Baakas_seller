...
class BaakasCircularLoader extends StatelessWidget {
  ...
  const BaakasCircularLoader({
    super.key,
    this.foregroundColor = BaakasColors.white,
    this.backgroundColor = BaakasColors.primaryColor,
  });
